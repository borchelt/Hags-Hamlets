...
def tavern_ascii():
    ...
    prints("@##@#%&$@#%%$^............$%&^#%#$$&%^*^&*%$^#$%$&%^&$^#$%#$&^&$^#^#^#^", .3)
    prints("#$@#$@#$@#      THE TAVERN    #$%#$%#^$%&$&%^&*%&%^&%^*^*%^*%**%^*%^*%^*%^*", .3)
    #tavern for now can change

def character_screen_ascii():

    prints("   ___ _                          _              __                          ")       
    prints("  / __\ |__   __ _ _ __ __ _  ___| |_ ___ _ __  / _\ ___ _ __ ___  ___ _ __  ")
    prints(" / /  | '_ \ / _` | '__/ _` |/ __| __/ _ \ '__| \ \ / __| '__/ _ \/ _ \ '_ \ ")
    prints("/ /___| | | | (_| | | | (_| | (__| ||  __/ |    _\ \ (__| | |  __/  __/ | | |")
    prints("\____/|_| |_|\__,_|_|  \__,_|\___|\__\___|_|    \__/\___|_|  \___|\___|_| |_|")

def inventory_ascii():


    prints("  _____                      _                   ")
    prints("  \_   \_ ____   _____ _ __ | |_ ___  _ __ _   _ ")
    prints("   / /\/ '_ \ \ / / _ \ '_ \| __/ _ \| '__| | | |")
    prints("/\/ /_ | | | \ V /  __/ | | | || (_) | |  | |_| |") 
    prints("\____/ |_| |_|\_/ \___|_| |_|\__\___/|_|   \__, |")
    prints("                                         |___/  /")

def woods_title_ascii():
...
def abandoned_cottage_title_ascii():
...
def rat_kings_nest_title_ascii():
