...
class map():
    ...
    bat = enemy.enemy("Bats","A swarm of bats clouds your vision. The sound is incredible as wings fly past your face and around your head.", 1, 
                        [bite, bite, bite], 10, [item("bat's wings")], "Your attack connects and the bats fall harshly, splattering on the ground.", old_mines_floor1_N)
    ...
    giant_spider = enemy.enemy("Giant Spider","A hulking, fierce insect. This is no time to be act idley. Look out!", 15, 
                        [bite, bite, bite], 10, [item("venomous sac"), item("spider eyes"), item("giant spider mandible")], "The spider crumples into a bent, twisted shape as it hugs its wounds. It dies, shortly after", old_mines_spider_lair)
    ...
    cemetery.interactables = [newGrave, medGrave, ancGrave, greg, smith]
    ...
    bandit = enemy.enemy("Bandit","A thug with no conscience. It's hard to believe there are people out here acting this way, despite the Hags presence.", 8, 
                        [dagger, dagger, shortsword], 10, [item("gold purse"), item("rapier"), item("strange document")], "You can tell that the bandit realized their mistake, just as it was too late. You saw the look in their eyes as they fail to dodge your killing blow. They collapse.", outskirts)
    bandit2 = enemy.enemy("Bandit","A thug with no conscience. It's hard to believe there are people out here acting this way, despite the Hags presence.", 8, 
                        [basic_bow, basic_bow, basic_bow], 10, [item("gold purse"), item("rapier"), item("strange document")], "You can tell that the bandit realized their mistake, just as it was too late. You saw the look in their eyes as they fail to dodge your killing blow. They collapse.", outskirts)
    ...
    drunkard = enemy.enemy("Drunkard"," \"You're not wise, picking a fight with me! Get 'im boys!", 3, 
                        [broken_bottle, broken_bottle, broken_bottle], 10, [item(" broken bottle")], "You hear a crunching sound as the drunkard falls face first into the edge of the table at velocity. He drops.", tavern)
    ...
    angry_spirit = enemy.enemy("Spirit","Suddenly a spectacularly spooky spectre swiftly swims through the air towards you. Oh my!", 3, 
                        [phantasmal_scream, phantasmal_scream, phantasmal_scream], 10, [item("ectoplasm"), item("ghostly blade")], "The spectre is spooped. They dissipate into nothingness, returning to the void.", tree)
